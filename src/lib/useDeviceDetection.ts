...
export const useDeviceDetection = () => {
  ...
  useEffect(() => {
    ...
    const checkMobile = () => {
      ...
      // Pojednostavljeni test za mobilne uređaje
      ...
      // Dodatna provera za veličinu ekrana (ispod 768px je mobilni)
      const mobileScreenSize = window.innerWidth <= 768;
      
      // Vraćamo true ako bilo koji od testova prođe
      return mobileRegex1 || mobileRegex2 || mobileScreenSize;
    };

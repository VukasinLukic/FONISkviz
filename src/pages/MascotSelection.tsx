    ...
    <div className="min-h-screen bg-primary p-2 sm:p-4 relative overflow-hidden flex flex-col">
      ...
      <div className="flex-grow flex flex-col items-center justify-center max-w-xl mx-auto z-20 relative">
        ...
        <div className="w-full flex flex-col items-center justify-center mt-1 mb-2 sm:mb-4">
          ...
          <motion.div 
            className="relative bg-accent/20 w-64 h-64 sm:w-72 sm:h-72 md:w-80 md:h-80 rounded-3xl flex items-center justify-center p-2 sm:p-4 border-[3px] border-accent/40 backdrop-blur-sm shadow-xl mb-2 sm:mb-4"
        ...
        <motion.button
          ...
          disabled={isLoading}
          className="bg-secondary text-white font-bold py-3 sm:py-4 px-6 sm:px-10 rounded-xl shadow-lg hover:bg-secondary/90 transition-colors disabled:opacity-50 disabled:cursor-not-allowed text-xl sm:text-lg w-[85%] sm:w-3/4 mt-2 sm:mt-4"
